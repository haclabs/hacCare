-- ============================================================================
-- REDEPLOY RESET FUNCTIONS WITH NEWBORN ASSESSMENT CLEANUP
-- ============================================================================
-- Adds DELETE FROM patient_newborn_assessments to both reset functions.
-- CRITICAL: Must be deployed as a migration (editing .sql files alone does
--           NOT update the live database — functions are compiled at deploy time).
-- ============================================================================
...
SELECT '✅ Redeploy complete' AS status, 'Both reset functions updated with newborn assessment cleanup' AS description;
