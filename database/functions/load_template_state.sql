...
-- LOAD TEMPLATE STATE
-- ============================================================================
-- Loads a named template state (simulation_template_states) into the
-- template's own tenant, replacing current live data, so an instructor can
-- edit that state via the normal template editing flow. p_state_id NULL
-- reloads the template's own default snapshot instead (discard-changes path,
