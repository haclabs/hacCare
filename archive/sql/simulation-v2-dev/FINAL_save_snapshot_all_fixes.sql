-- ===========================================================================
-- FINAL CORRECTED VERSION: Fixed diabetic_records AND wound_assessments
-- ===========================================================================
...
BEGIN
  ...
  v_snapshot := jsonb_build_object(
    ...
    'diabetic_records', (
      ...
      JOIN patients p ON p.patient_id = dr.patient_id  -- TEXT = TEXT join
      WHERE p.tenant_id = v_tenant_id
    ),
    'bowel_records', (
    ...
    'wound_assessments', (
      ...
      WHERE wa.tenant_id = v_tenant_id  -- Direct tenant filtering
    ),
    'handover_notes', (
...
SELECT '✅ save_template_snapshot function RECREATED with ALL fixes!' as status;
