-- ===========================================================================
-- CORRECTED restore_snapshot_to_tenant function
-- ===========================================================================
-- Fixes:
-- 1. Only include tenant_id for tables that have it
-- 2. Use correct join for diabetic_records (text patient_id)
-- 3. Fix wound_assessments (no wound_id column)
-- ===========================================================================
...
BEGIN
  ...
  IF p_snapshot->'patients' IS NOT NULL THEN
    ...
    LOOP
      ...
      -- Generate new unique patient_id with SIM prefix and random suffix
...
SELECT '✅ restore_snapshot_to_tenant function CORRECTED!' as status;
