...
/**
 * Shared privacy notice content — rendered by both PrivacyNoticeModal
 * (login page overlay) and PrivacyPage (/privacy standalone route).
 */
export const PrivacyContent: React.FC = () => (
  <div className="space-y-5 text-sm text-gray-700 leading-relaxed">
    ...
    <section>
      ...
      <p>
        This platform is operated in compliance with Canada's{' '}
        <span className="font-medium">Personal Information Protection and Electronic Documents Act (PIPEDA)</span>{' '}
        and applicable provincial privacy legislation. For institutions in the United States, we support
        compliance with <span className="font-medium">FERPA</span> by restricting student record access
        to instructors and administrators with a legitimate educational interest. This platform does not
        process real patient health information and is therefore not subject to HIPAA.
      </p>
    </section>
