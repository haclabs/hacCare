...
import { runConnectionTest, getConnectionStatus } from '../../lib/connectionTest';
import { 
  AlertTriangle, CheckCircle, XCircle, RefreshCw, 
  Database, Key, Globe, Lock, Table, FileText 
} from 'lucide-react';
  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <h3 className="text-lg font-medium text-gray-900 dark:text-white">Connection Diagnostics</h3>
        <button
