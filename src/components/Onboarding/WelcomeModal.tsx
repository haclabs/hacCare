...
/** Matches the mint accent in HacCareLogo, kept as the modal's single accent color. */
const MINT = '#3fbf9a';
    ...
    >
      ...
      >
        ...
        <div className="px-8 py-6">
          {index === 0 && profile?.first_name && (
            <p className="text-sm font-semibold text-gray-900 mb-2">Hi {profile.first_name},</p>
          )}
          ...
          <div className="flex items-center gap-1.5">
            {SLIDES.map((s, i) => (
              <button
                ...
                style={i === index ? { backgroundColor: MINT } : undefined}
          ...
          <div className="flex items-center gap-2">
            ...
            {isLast ? (
              <button
                ...
                onMouseEnter={(e) => (e.currentTarget.style.backgroundColor = MINT_DARK)}
