...
export const MedicationAdministration: React.FC<MedicationAdministrationProps> = ({
  ...
  const activeMeds = allMedications.filter(med => med.status === 'Active');
      ...
      <div className="border-b border-gray-200">
        <nav className="flex space-x-8">
          ...
          >
            ...
            <span>Overview ({activeMeds.length})</span>
          </button>
            ...
            {activeMeds.length === 0 ? (
              ...
              <div className="space-y-4">
                {activeMeds.map((medication) => {
                  ...
                  if (medication.category === 'prn') categoryColor = 'bg-green-100 text-green-800';
                  if (medication.category === 'continuous') categoryColor = 'bg-purple-100 text-purple-800';
                  if (medication.category === 'unscheduled') categoryColor = 'bg-yellow-100 text-yellow-800';
                        ...
                        <div>
                          <div className="flex items-center space-x-2">
                            ...
                            <span className={`px-2 py-1 rounded-full text-xs font-medium ${categoryColor}`}>
                              {medication.category ? medication.category.charAt(0).toUpperCase() + medication.category.slice(1) : 'Scheduled'}
                            </span>
                          </div>
