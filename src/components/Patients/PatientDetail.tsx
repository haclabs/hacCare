...
export const PatientDetail: React.FC<PatientDetailProps> = ({ patient, onBack }) => {
  ...
  // Calculate days admitted with date validation
  ...
  const handleSaveMedication = async (medicationData: any) => {
    try {
      ...
      await updatePatient(currentPatient.id, { medications: updatedMedications });
  ...
  const handleSaveNote = async (noteData: any) => {
    try {
      ...
      await updatePatient(currentPatient.id, { notes: updatedNotes });
  ...
  const hasVitalsData = currentPatient.vitals && currentPatient.vitals.length > 0;
  const latestVitals = hasVitalsData ? currentPatient.vitals[0] : null;
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  <div className="bg-blue-50 rounded-lg p-6 border border-blue-200">
                    <div className="flex items-center justify-between mb-3">
                      ...
                      <span className="text-2xl font-bold text-blue-900">{latestVitals?.temperature || 'N/A'}°F</span>
                    </div>
                  ...
                  <div className="bg-red-50 rounded-lg p-6 border border-red-200">
                    <div className="flex items-center justify-between mb-3">
                      ...
                      <span className="text-2xl font-bold text-red-900">{latestVitals?.heartRate || 'N/A'}</span>
                    </div>
                  ...
                  <div className="bg-purple-50 rounded-lg p-6 border border-purple-200">
                    <div className="flex items-center justify-between mb-3">
                      ...
                      <span className="text-2xl font-bold text-purple-900">
                        {latestVitals?.bloodPressure ? `${latestVitals.bloodPressure.systolic}/${latestVitals.bloodPressure.diastolic}` : 'N/A'}
                      </span>
                    </div>
                  ...
                  <div className="bg-green-50 rounded-lg p-6 border border-green-200">
                    <div className="flex items-center justify-between mb-3">
                      ...
                      <span className="text-2xl font-bold text-green-900">{latestVitals?.oxygenSaturation || 'N/A'}%</span>
                    </div>
                  ...
                  <div className="bg-indigo-50 rounded-lg p-6 border border-indigo-200">
                    <div className="flex items-center justify-between mb-3">
                      ...
                      <span className="text-2xl font-bold text-indigo-900">{latestVitals?.respiratoryRate || 'N/A'}</span>
                    </div>
                        ...
                        <div className="flex items-center space-x-4 text-sm">
                          <div className="flex items-center space-x-1">
                            ...
                            <span className="font-medium text-blue-600">
                              {medication.next_due ? format(new Date(medication.next_due), 'MMM dd, HH:mm') : 'N/A'}
                            </span>
                          </div>
                          <div className="flex items-center space-x-1">
                            ...
                            <span className="font-medium">
                              {medication.start_date ? format(new Date(medication.start_date), 'MMM dd, yyyy') : 'N/A'}
                            </span>
                          </div>
                        </div>
                      </div>
            ...
            <div className="space-y-4">
              {currentPatient.notes && currentPatient.notes.length > 0 ? (
                ...
                <div className="bg-gray-50 border-2 border-dashed border-gray-300 rounded-lg p-8 text-center">
                  ...
                  <p className="text-gray-600 mb-4">No notes have been added for this patient yet.</p>
                  <button
                    onClick={() => setShowNoteForm(true)}
                    className="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition-colors flex items-center space-x-2 mx-auto"
                  >
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white border border-gray-200 rounded-lg p-6">
              <p className="text-gray-600">
                Detailed admission records including insurance information, attending physician, 
              ...
              <div className="mt-4">
                ...
                >
                  View and edit admission records →
                </button>
              </div>
            </div>
          </div>
            ...
            <div className="bg-white border border-gray-200 rounded-lg p-6">
              ...
              <div className="mt-4">
                <button
                  ...
                  className="text-blue-600 hover:text-blue-800 font-medium"
                >
                  View and edit advanced directives →
                </button>
              </div>
            </div>
          </div>
    ...
    <div className="min-h-screen bg-gray-100">
      ...
      {showDirectivesForm && (
        <AdvancedDirectivesForm
          ...
          onSave={() => setShowDirectivesForm(false)}
        />
      )}
